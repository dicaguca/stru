(() => {
    ...
    const priorityColors =
        (Stru.constants && Stru.constants.priorityColors) || {
            ...
            personal: { bg: "bg-fuchsia-50", border: "border-[#922fa6]", dot: "bg-[#922fa6]" },
    ...
    const PRIORITY_UI = {
        ...
        personal: { bg: "bg-fuchsia-50", border: "border-[#922fa6]", text: "text-fuchsia-700", dot: "bg-[#922fa6]", label: "Personal" },
                            ...
                            <div className="space-y-3">
                                {visibleTasks.map((task) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <PrioritySelector currentPriority={task.priority} onSelect={(next) => onUpdate?.(task.id, { priority: next })} />
